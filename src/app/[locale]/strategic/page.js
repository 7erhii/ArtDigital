...
// Images
import StrategicHeroImage from "@/assets/images/image-hero-marketing-strategic.png";
...
export default function BackendPage({ params: { locale } }) {
  ...
  return (
    <div>
      ...
      <CustomHero
        sectionName="Strategic"
        imageSrc={StrategicHeroImage}
        imageAlt={"Digital marketing image, people in a front of a desk"}
        coloredWords={["Strategic", "Marketing"]}
